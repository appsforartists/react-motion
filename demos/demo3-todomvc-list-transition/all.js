...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = _react2['default'].createClass({
	  ...
	  handleToggleAll: function handleToggleAll() {
	    var allDone = this.state.todos.some(function (_ref2) {
	      var data = _ref2.data;
	      return data.isDone;
	    });
	    this.setState({
	      todos: this.state.todos.map(function (_ref3) {
	        ...
	        var isDone = _ref3$data.isDone;
	        return { key: key, data: { text: text, isDone: !allDone } };
	      })
	    });
	  },
